...
Blog post: see `docs/blog-drafts/genai-observability-01-jbang-cli-tui.adoc` in the
...
```sh
camel run https://github.com/apache/camel-jbang-examples/tree/main/ai/genai-observability \
  --observe \
  --dependency=camel-langchain4j-chat \
  --dependency=camel-ai-observability \
  --dependency=langchain4j-ollama
