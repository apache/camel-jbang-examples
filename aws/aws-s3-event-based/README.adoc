...
The example provides an automated integration test (`aws-s3-cdc-log.citrus.it.yaml`) that you can run with the https://citrusframework.org/[Citrus] test framework.
