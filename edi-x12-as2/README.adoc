...
The example provides an automated integration test (`edi-x12-as2.citrus.it.yaml`) that you can run with the https://citrusframework.org/[Citrus] test framework. Please make sure to have installed Citrus as a JBang application.
