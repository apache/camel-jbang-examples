...
The example provides an automated integration test (`ftp.citrus.it.yaml`) in the [Citrus](https://citrusframework.org/) YAML DSL, which the Camel CLI runs (the test plugin installs on first use).
