...
The example provides an automated integration test (`petstore-client.citrus.it.yaml`) that you can run with the https://citrusframework.org/[Citrus] test framework.
