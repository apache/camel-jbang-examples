...
```sh
$ jbang -Dcamel.jbang.version=4.16.0 camel@apache/camel run --dep=mvn:org.springframework.vault:spring-vault-core:3.2.0 --dep=camel:pqc --properties=application.properties pqc-document-signing.yaml
```
